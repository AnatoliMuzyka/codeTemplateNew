...
Процедура ОтчетОСВ(НоменклатурыОтбор)
    ...
    ДатаНачалаОтбора = Дата(2019,1,1);
	...
	ПользовательскиеНастройкиКомпоновкиДанных.ДополнительныеСвойства.Вставить("НачалоПериода" , ДатаНачалаОтбора);
	...
	ПользовательскиеНастройкиКомпоновкиДанных.ДополнительныеСвойства.Вставить("ДополнительныеПоля", ДополнительныеПоля());
	ПользовательскиеНастройкиКомпоновкиДанных.ДополнительныеСвойства.Вставить("РазмещениеДополнительныхПолей", 1);
	...
	ЗаполнятьТиповыеНастройки.Вставить("Показатели"     , Ложь);
	ЗаполнятьТиповыеНастройки.Вставить("ДополнительныеПоля"     , Ложь);
	...
	ОткрытьФорму("Отчет." + ИмяОтчета + ".Форма.ФормаОтчета", ПараметрыОтчета,ЭтаФорма, Строка(УникальныйКлюч));
КонецПроцедуры
...
Функция ДополнительныеПоля()
	...
	НоваяСтрока = Новый Структура("Использование, Поле, Представление");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.Поле          = "Субконто1.san_id_crm";
	НоваяСтрока.Представление = "Номенклатура.Ид в CRM";
